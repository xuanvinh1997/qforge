...
# Backward-compatible alias
HighDim_encode = high_dim_encode
...
# Backward-compatible alias
Chebyshev_encode = chebyshev_encode
...
# Backward-compatible alias
ParamZFeatureMap_encode = param_z_feature_map_encode
...
# Backward-compatible alias
SeparableRXEncoding_encode = separable_rx_encode
...
# Backward-compatible alias
HardwareEfficientEmbeddingRx_encode = hardware_efficient_embed_encode
...
# Backward-compatible alias
ZFeatureMap_encode = z_feature_map_encode
...
# Backward-compatible alias
ZZFeatureMap_encode = zz_feature_map_encode
