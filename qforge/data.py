# -*- coding: utf-8 -*-
# author: vinhpx
"""Quantum data analysis utilities."""
import numpy as np
import math
...
def spectral_complex_kernel(kernel, lambda_K = 0.1):
...
class EntanglementEntropy:
    ...
    def reduced_density_matrix(self, keep_qubits):
        ...
        if _HAS_CPP:
            return _qforge_core.reduced_density_matrix(
                np.ascontiguousarray(amplitudes), self.n_qubits, list(keep_qubits))
